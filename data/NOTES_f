...
struct sigaction {
    ...
    void (*sa_sigaction)(int, siginfo_t *, void *); // Alternative signal handler function pointer (for extended signal information)
    sigset_t sa_mask;              // Set of signals to be blocked during the execution of the signal handler
    int sa_flags;                  // Flags to modify the behavior of the signal handler
};
